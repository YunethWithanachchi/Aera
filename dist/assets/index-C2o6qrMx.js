(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();const bo=()=>{};var _i={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function No(n){return Es(void 0,n)}function Es(n,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const t=e;return new Date(t.getTime());case Object:n===void 0&&(n={});break;case Array:n=[];break;default:return e}for(const t in e)!e.hasOwnProperty(t)||!Ro(t)||(n[t]=Es(n[t],e[t]));return n}function Ro(n){return n!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ko=()=>Ao().__FIREBASE_DEFAULTS__,Do=()=>{if(typeof process>"u"||typeof _i>"u")return;const n=_i.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},Po=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=n&&sn(n[1]);return e&&JSON.parse(e)},Is=()=>{try{return bo()||ko()||Do()||Po()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},xo=n=>Is()?.emulatorHosts?.[n],Oo=n=>{const e=xo(n);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const i=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),i]:[e.substring(0,t),i]},ws=()=>Is()?.config;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bn(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch{return!1}}async function Mo(n){return(await fetch(n,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wo(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function bs(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Wo())}function Ho(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function $o(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Vo(){return ys.NODE_ADMIN===!0}function Ts(){try{return typeof indexedDB=="object"}catch{return!1}}function Ss(){return new Promise((n,e)=>{try{let t=!0;const i="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(i);s.onsuccess=()=>{s.result.close(),t||self.indexedDB.deleteDatabase(i),n(!0)},s.onupgradeneeded=()=>{t=!1},s.onerror=()=>{e(s.error?.message||"")}}catch(t){e(t)}})}function qo(){return!(typeof navigator>"u"||!navigator.cookieEnabled)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Go="FirebaseError";class Ce extends Error{constructor(e,t,i){super(t),this.code=e,this.customData=i,this.name=Go,Object.setPrototypeOf(this,Ce.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,kt.prototype.create)}}class kt{constructor(e,t,i){this.service=e,this.serviceName=t,this.errors=i}create(e,...t){const i=t[0]||{},s=`${this.service}/${e}`,r=this.errors[e],o=r?zo(r,i):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new Ce(s,a,i)}}function zo(n,e){return n.replace(jo,(t,i)=>{const s=e[i];return s!=null?String(s):`<${i}?>`})}const jo=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ns=function(n){let e={},t={},i={},s="";try{const r=n.split(".");e=je(sn(r[0])||""),t=je(sn(r[1])||""),s=r[2],i=t.d||{},delete t.d}catch{}return{header:e,claims:t,data:i,signature:s}},Ko=function(n){const e=Ns(n),t=e.claims;return!!t&&typeof t=="object"&&t.hasOwnProperty("iat")},Yo=function(n){const e=Ns(n).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qo(n){const e=[];for(const[t,i]of Object.entries(n))Array.isArray(i)?i.forEach(s=>{e.push(encodeURIComponent(t)+"="+encodeURIComponent(s))}):e.push(encodeURIComponent(t)+"="+encodeURIComponent(i));return e.length?"&"+e.join("&"):""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zo=1e3,ea=2,ta=14400*1e3,na=.5;function vi(n,e=Zo,t=ea){const i=e*Math.pow(t,n),s=Math.round(na*i*(Math.random()-.5)*2);return Math.min(ta,i+s)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var w;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(w||(w={}));const aa={debug:w.DEBUG,verbose:w.VERBOSE,info:w.INFO,warn:w.WARN,error:w.ERROR,silent:w.SILENT},la=w.INFO,ca={[w.DEBUG]:"log",[w.VERBOSE]:"log",[w.INFO]:"info",[w.WARN]:"warn",[w.ERROR]:"error"},ha=(n,e,...t)=>{if(e<n.logLevel)return;const i=new Date().toISOString(),s=ca[e];if(s)console[s](`[${i}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Sn{constructor(e){this.name=e,this._logLevel=la,this._logHandler=ha,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in w))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?aa[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,w.DEBUG,...e),this._logHandler(this,w.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,w.VERBOSE,...e),this._logHandler(this,w.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,w.INFO,...e),this._logHandler(this,w.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,w.WARN,...e),this._logHandler(this,w.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,w.ERROR,...e),this._logHandler(this,w.ERROR,...e)}}const ua=(n,e)=>e.some(t=>n instanceof t);let Ci,Ei;function da(){return Ci||(Ci=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function fa(){return Ei||(Ei=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Rs=new WeakMap,rn=new WeakMap,As=new WeakMap,Vt=new WeakMap,Nn=new WeakMap;function pa(n){const e=new Promise((t,i)=>{const s=()=>{n.removeEventListener("success",r),n.removeEventListener("error",o)},r=()=>{t(te(n.result)),s()},o=()=>{i(n.error),s()};n.addEventListener("success",r),n.addEventListener("error",o)});return e.then(t=>{t instanceof IDBCursor&&Rs.set(t,n)}).catch(()=>{}),Nn.set(e,n),e}function _a(n){if(rn.has(n))return;const e=new Promise((t,i)=>{const s=()=>{n.removeEventListener("complete",r),n.removeEventListener("error",o),n.removeEventListener("abort",o)},r=()=>{t(),s()},o=()=>{i(n.error||new DOMException("AbortError","AbortError")),s()};n.addEventListener("complete",r),n.addEventListener("error",o),n.addEventListener("abort",o)});rn.set(n,e)}let on={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return rn.get(n);if(e==="objectStoreNames")return n.objectStoreNames||As.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return te(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function ma(n){on=n(on)}function ga(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const i=n.call(qt(this),e,...t);return As.set(i,e.sort?e.sort():[e]),te(i)}:fa().includes(n)?function(...e){return n.apply(qt(this),e),te(Rs.get(this))}:function(...e){return te(n.apply(qt(this),e))}}function ya(n){return typeof n=="function"?ga(n):(n instanceof IDBTransaction&&_a(n),ua(n,da())?new Proxy(n,on):n)}function te(n){if(n instanceof IDBRequest)return pa(n);if(Vt.has(n))return Vt.get(n);const e=ya(n);return e!==n&&(Vt.set(n,e),Nn.set(e,n)),e}const qt=n=>Nn.get(n);function ks(n,e,{blocked:t,upgrade:i,blocking:s,terminated:r}={}){const o=indexedDB.open(n,e),a=te(o);return i&&o.addEventListener("upgradeneeded",l=>{i(te(o.result),l.oldVersion,l.newVersion,te(o.transaction),l)}),t&&o.addEventListener("blocked",l=>t(l.oldVersion,l.newVersion,l)),a.then(l=>{r&&l.addEventListener("close",()=>r()),s&&l.addEventListener("versionchange",c=>s(c.oldVersion,c.newVersion,c))}).catch(()=>{}),a}const va=["get","getKey","getAll","getAllKeys","count"],Ca=["put","add","delete","clear"],Gt=new Map;function Ii(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Gt.get(e))return Gt.get(e);const t=e.replace(/FromIndex$/,""),i=e!==t,s=Ca.includes(t);if(!(t in(i?IDBIndex:IDBObjectStore).prototype)||!(s||va.includes(t)))return;const r=async function(o,...a){const l=this.transaction(o,s?"readwrite":"readonly");let c=l.store;return i&&(c=c.index(a.shift())),(await Promise.all([c[t](...a),s&&l.done]))[0]};return Gt.set(e,r),r}ma(n=>({...n,get:(e,t,i)=>Ii(e,t)||n.get(e,t,i),has:(e,t)=>!!Ii(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ea{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Ia(t)){const i=t.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(t=>t).join(" ")}}function Ia(n){return n.getComponent()?.type==="VERSION"}const an="@firebase/app",wi="0.14.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Q=new Sn("@firebase/app"),wa="@firebase/app-compat",ba="@firebase/analytics-compat",Ta="@firebase/analytics",Sa="@firebase/app-check-compat",Na="@firebase/app-check",Ra="@firebase/auth",Aa="@firebase/auth-compat",ka="@firebase/database",Da="@firebase/data-connect",Pa="@firebase/database-compat",xa="@firebase/functions",Oa="@firebase/functions-compat",Ma="@firebase/installations",La="@firebase/installations-compat",Fa="@firebase/messaging",Ba="@firebase/messaging-compat",Ua="@firebase/performance",Wa="@firebase/performance-compat",Ha="@firebase/remote-config",$a="@firebase/remote-config-compat",Va="@firebase/storage",qa="@firebase/storage-compat",Ga="@firebase/firestore",za="@firebase/ai",ja="@firebase/firestore-compat",Ka="firebase",Ya="12.4.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ln="[DEFAULT]",Qa={[an]:"fire-core",[wa]:"fire-core-compat",[Ta]:"fire-analytics",[ba]:"fire-analytics-compat",[Na]:"fire-app-check",[Sa]:"fire-app-check-compat",[Ra]:"fire-auth",[Aa]:"fire-auth-compat",[ka]:"fire-rtdb",[Da]:"fire-data-connect",[Pa]:"fire-rtdb-compat",[xa]:"fire-fn",[Oa]:"fire-fn-compat",[Ma]:"fire-iid",[La]:"fire-iid-compat",[Fa]:"fire-fcm",[Ba]:"fire-fcm-compat",[Ua]:"fire-perf",[Wa]:"fire-perf-compat",[Ha]:"fire-rc",[$a]:"fire-rc-compat",[Va]:"fire-gcs",[qa]:"fire-gcs-compat",[Ga]:"fire-fst",[ja]:"fire-fst-compat",[za]:"fire-vertex","fire-js":"fire-js",[Ka]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ft=new Map,Xa=new Map,cn=new Map;function bi(n,e){try{n.container.addComponent(e)}catch(t){Q.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function se(n){const e=n.name;if(cn.has(e))return Q.debug(`There were multiple attempts to register component ${e}.`),!1;cn.set(e,n);for(const t of ft.values())bi(t,n);for(const t of Xa.values())bi(t,n);return!0}function nt(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function Ja(n){return n==null?!1:n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tl=Ya;function Ds(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const i={name:ln,automaticDataCollectionEnabled:!0,...e},s=i.name;if(typeof s!="string"||!s)throw ne.create("bad-app-name",{appName:String(s)});if(t||(t=ws()),!t)throw ne.create("no-options");const r=ft.get(s);if(r){if(Ke(t,r.options)&&Ke(i,r.config))return r;throw ne.create("duplicate-app",{appName:s})}const o=new oa(s);for(const l of cn.values())o.addComponent(l);const a=new el(t,i,o);return ft.set(s,a),a}function Ps(n=ln){const e=ft.get(n);if(!e&&n===ln&&ws())return Ds();if(!e)throw ne.create("no-app",{appName:n});return e}function q(n,e,t){let i=Qa[n]??n;t&&(i+=`-${t}`);const s=i.match(/\s|\//),r=e.match(/\s|\//);if(s||r){const o=[`Unable to register library "${i}" with version "${e}":`];s&&o.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&r&&o.push("and"),r&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Q.warn(o.join(" "));return}se(new Y(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rl=1024,ol=30;class al{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new cl(t),this._heartbeatsCachePromise=this._storage.read().then(i=>(this._heartbeatsCache=i,i))}async triggerHeartbeat(){try{const t=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),i=Si();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===i||this._heartbeatsCache.heartbeats.some(s=>s.date===i))return;if(this._heartbeatsCache.heartbeats.push({date:i,agent:t}),this._heartbeatsCache.heartbeats.length>ol){const s=hl(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(s,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){Q.warn(e)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=Si(),{heartbeatsToSend:t,unsentEntries:i}=ll(this._heartbeatsCache.heartbeats),s=ut(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(e){return Q.warn(e),""}}}function Si(){return new Date().toISOString().substring(0,10)}function ll(n,e=rl){const t=[];let i=n.slice();for(const s of n){const r=t.find(o=>o.agent===s.agent);if(r){if(r.dates.push(s.date),Ni(t)>e){r.dates.pop();break}}else if(t.push({agent:s.agent,dates:[s.date]}),Ni(t)>e){t.pop();break}i=i.slice(1)}return{heartbeatsToSend:t,unsentEntries:i}}class cl{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Ts()?Ss().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await sl(this.app);return t?.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const i=await this.read();return Ti(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const i=await this.read();return Ti(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function Ni(n){return ut(JSON.stringify({version:2,heartbeats:n})).length}function hl(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let i=1;i<n.length;i++)n[i].date<t&&(t=n[i].date,e=i);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ul(n){se(new Y("platform-logger",e=>new Ea(e),"PRIVATE")),se(new Y("heartbeat",e=>new al(e),"PRIVATE")),q(an,wi,n),q(an,wi,"esm2020"),q("fire-js","")}ul("");var dl="firebase",fl="12.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */q(dl,fl,"app");const Ms="@firebase/installations",Rn="0.6.19";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ls=1e4,Fs=`w:${Rn}`,Bs="FIS_v2",pl="https://firebaseinstallations.googleapis.com/v1",_l=3600*1e3,ml="installations",gl="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Il({appConfig:n,heartbeatServiceProvider:e},{fid:t}){const i=Ws(n),s=Vs(n),r=e.getImmediate({optional:!0});if(r){const c=await r.getHeartbeatsHeader();c&&s.append("x-firebase-client",c)}const o={fid:t,authVersion:Bs,appId:n.appId,sdkVersion:Fs},a={method:"POST",headers:s,body:JSON.stringify(o)},l=await qs(()=>fetch(i,a));if(l.ok){const c=await l.json();return{fid:c.fid||t,registrationStatus:2,refreshToken:c.refreshToken,authToken:Hs(c.authToken)}}else throw await $s("Create Installation",l)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bl=/^[cdef][\w-]{21}$/,hn="";function Tl(){try{const n=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(n),n[0]=112+n[0]%16;const t=Sl(n);return bl.test(t)?t:hn}catch{return hn}}function Sl(n){return wl(n).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zs=new Map;function js(n,e){const t=Pt(n);Ks(t,e),Nl(t,e)}function Ks(n,e){const t=zs.get(n);if(t)for(const i of t)i(e)}function Nl(n,e){const t=Rl();t&&t.postMessage({key:n,fid:e}),Al()}let ue=null;function Rl(){return!ue&&"BroadcastChannel"in self&&(ue=new BroadcastChannel("[Firebase] FID Change"),ue.onmessage=n=>{Ks(n.data.key,n.data.fid)}),ue}function Al(){zs.size===0&&ue&&(ue.close(),ue=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function kn(n){let e;const t=await xt(n.appConfig,i=>{const s=Pl(i),r=xl(n,s);return e=r.registrationPromise,r.installationEntry});return t.fid===hn?{installationEntry:await e}:{installationEntry:t,registrationPromise:e}}function Pl(n){const e=n||{fid:Tl(),registrationStatus:0};return Qs(e)}function xl(n,e){if(e.registrationStatus===0){if(!navigator.onLine){const s=Promise.reject(pe.create("app-offline"));return{installationEntry:e,registrationPromise:s}}const t={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},i=Ol(n,t);return{installationEntry:t,registrationPromise:i}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:Ml(n)}:{installationEntry:e}}async function Ol(n,e){try{const t=await Il(n,e);return pt(n.appConfig,t)}catch(t){throw Us(t)&&t.customData.serverCode===409?await Ys(n.appConfig):await pt(n.appConfig,{fid:e.fid,registrationStatus:0}),t}}async function Ml(n){let e=await Ri(n.appConfig);for(;e.registrationStatus===1;)await Gs(100),e=await Ri(n.appConfig);if(e.registrationStatus===0){const{installationEntry:t,registrationPromise:i}=await kn(n);return i||t}return e}function Ri(n){return xt(n,e=>{if(!e)throw pe.create("installation-not-found");return Qs(e)})}function Qs(n){return Ll(n)?{fid:n.fid,registrationStatus:0}:n}function Ll(n){return n.registrationStatus===1&&n.registrationTime+Ls<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Fl({appConfig:n,heartbeatServiceProvider:e},t){const i=Bl(n,t),s=vl(n,t),r=e.getImmediate({optional:!0});if(r){const c=await r.getHeartbeatsHeader();c&&s.append("x-firebase-client",c)}const o={installation:{sdkVersion:Fs,appId:n.appId}},a={method:"POST",headers:s,body:JSON.stringify(o)},l=await qs(()=>fetch(i,a));if(l.ok){const c=await l.json();return Hs(c)}else throw await $s("Generate Auth Token",l)}function Bl(n,{fid:e}){return`${Ws(n)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Dn(n,e=!1){let t;const i=await xt(n.appConfig,r=>{if(!Xs(r))throw pe.create("not-registered");const o=r.authToken;if(!e&&Hl(o))return r;if(o.requestStatus===1)return t=Ul(n,e),r;{if(!navigator.onLine)throw pe.create("app-offline");const a=Vl(r);return t=Wl(n,a),a}});return t?await t:i.authToken}async function Ul(n,e){let t=await Ai(n.appConfig);for(;t.authToken.requestStatus===1;)await Gs(100),t=await Ai(n.appConfig);const i=t.authToken;return i.requestStatus===0?Dn(n,e):i}function Ai(n){return xt(n,e=>{if(!Xs(e))throw pe.create("not-registered");const t=e.authToken;return ql(t)?{...e,authToken:{requestStatus:0}}:e})}async function Wl(n,e){try{const t=await Fl(n,e),i={...e,authToken:t};return await pt(n.appConfig,i),t}catch(t){if(Us(t)&&(t.customData.serverCode===401||t.customData.serverCode===404))await Ys(n.appConfig);else{const i={...e,authToken:{requestStatus:0}};await pt(n.appConfig,i)}throw t}}function Xs(n){return n!==void 0&&n.registrationStatus===2}function Hl(n){return n.requestStatus===2&&!$l(n)}function $l(n){const e=Date.now();return e<n.creationTime||n.creationTime+n.expiresIn<e+_l}function Vl(n){const e={requestStatus:1,requestTime:Date.now()};return{...n,authToken:e}}function ql(n){return n.requestStatus===1&&n.requestTime+Ls<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gl(n){const e=n,{installationEntry:t,registrationPromise:i}=await kn(e);return i?i.catch(console.error):Dn(e).catch(console.error),t.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zl(n,e=!1){const t=n;return await jl(t),(await Dn(t,e)).token}async function jl(n){const{registrationPromise:e}=await kn(n);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kl(n){if(!n||!n.options)throw Kt("App Configuration");if(!n.name)throw Kt("App Name");const e=["projectId","apiKey","appId"];for(const t of e)if(!n.options[t])throw Kt(t);return{appName:n.name,projectId:n.options.projectId,apiKey:n.options.apiKey,appId:n.options.appId}}function Kt(n){return pe.create("missing-app-config-values",{valueName:n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Js="installations",Yl="installations-internal",Ql=n=>{const e=n.getProvider("app").getImmediate(),t=Kl(e),i=nt(e,"heartbeat");return{app:e,appConfig:t,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()}},Xl=n=>{const e=n.getProvider("app").getImmediate(),t=nt(e,Js).getImmediate();return{getId:()=>Gl(t),getToken:s=>zl(t,s)}};function Jl(){se(new Y(Js,Ql,"PUBLIC")),se(new Y(Yl,Xl,"PRIVATE"))}Jl();q(Ms,Rn);q(Ms,Rn,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _t="analytics",Zl="firebase_id",ec="origin",tc=60*1e3,nc="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",Pn="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sc(n){if(!n.startsWith(Pn)){const e=U.create("invalid-gtag-resource",{gtagURL:n});return O.warn(e.message),""}return n}function Zs(n){return Promise.all(n.map(e=>e.catch(t=>t)))}function rc(n,e){let t;return window.trustedTypes&&(t=window.trustedTypes.createPolicy(n,e)),t}function oc(n,e){const t=rc("firebase-js-sdk-policy",{createScriptURL:sc}),i=document.createElement("script"),s=`${Pn}?l=${n}&id=${e}`;i.src=t?t?.createScriptURL(s):s,i.async=!0,document.head.appendChild(i)}function ac(n){let e=[];return Array.isArray(window[n])?e=window[n]:window[n]=e,e}async function lc(n,e,t,i,s,r){const o=i[s];try{if(o)await e[o];else{const l=(await Zs(t)).find(c=>c.measurementId===s);l&&await e[l.appId]}}catch(a){O.error(a)}n("config",s,r)}async function cc(n,e,t,i,s){try{let r=[];if(s&&s.send_to){let o=s.send_to;Array.isArray(o)||(o=[o]);const a=await Zs(t);for(const l of o){const c=a.find(u=>u.measurementId===l),d=c&&e[c.appId];if(d)r.push(d);else{r=[];break}}}r.length===0&&(r=Object.values(e)),await Promise.all(r),n("event",i,s||{})}catch(r){O.error(r)}}function hc(n,e,t,i){async function s(r,...o){try{if(r==="event"){const[a,l]=o;await cc(n,e,t,a,l)}else if(r==="config"){const[a,l]=o;await lc(n,e,t,i,a,l)}else if(r==="consent"){const[a,l]=o;n("consent",a,l)}else if(r==="get"){const[a,l,c]=o;n("get",a,l,c)}else if(r==="set"){const[a]=o;n("set",a)}else n(r,...o)}catch(a){O.error(a)}}return s}function uc(n,e,t,i,s){let r=function(...o){window[i].push(arguments)};return window[s]&&typeof window[s]=="function"&&(r=window[s]),window[s]=hc(r,n,e,t),{gtagCore:r,wrappedGtag:window[s]}}function dc(n){const e=window.document.getElementsByTagName("script");for(const t of Object.values(e))if(t.src&&t.src.includes(Pn)&&t.src.includes(n))return t;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fc=30,pc=1e3;class _c{constructor(e={},t=pc){this.throttleMetadata=e,this.intervalMillis=t}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,t){this.throttleMetadata[e]=t}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}}const er=new _c;function mc(n){return new Headers({Accept:"application/json","x-goog-api-key":n})}async function gc(n){const{appId:e,apiKey:t}=n,i={method:"GET",headers:mc(t)},s=nc.replace("{app-id}",e),r=await fetch(s,i);if(r.status!==200&&r.status!==304){let o="";try{const a=await r.json();a.error?.message&&(o=a.error.message)}catch{}throw U.create("config-fetch-failed",{httpStatus:r.status,responseMessage:o})}return r.json()}async function yc(n,e=er,t){const{appId:i,apiKey:s,measurementId:r}=n.options;if(!i)throw U.create("no-app-id");if(!s){if(r)return{measurementId:r,appId:i};throw U.create("no-api-key")}const o=e.getThrottleMetadata(i)||{backoffCount:0,throttleEndTimeMillis:Date.now()},a=new Ec;return setTimeout(async()=>{a.abort()},tc),tr({appId:i,apiKey:s,measurementId:r},o,a,e)}async function tr(n,{throttleEndTimeMillis:e,backoffCount:t},i,s=er){const{appId:r,measurementId:o}=n;try{await vc(i,e)}catch(a){if(o)return O.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${o} provided in the "measurementId" field in the local Firebase config. [${a?.message}]`),{appId:r,measurementId:o};throw a}try{const a=await gc(n);return s.deleteThrottleMetadata(r),a}catch(a){const l=a;if(!Cc(l)){if(s.deleteThrottleMetadata(r),o)return O.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${o} provided in the "measurementId" field in the local Firebase config. [${l?.message}]`),{appId:r,measurementId:o};throw a}const c=Number(l?.customData?.httpStatus)===503?vi(t,s.intervalMillis,fc):vi(t,s.intervalMillis),d={throttleEndTimeMillis:Date.now()+c,backoffCount:t+1};return s.setThrottleMetadata(r,d),O.debug(`Calling attemptFetch again in ${c} millis`),tr(n,d,i,s)}}function vc(n,e){return new Promise((t,i)=>{const s=Math.max(e-Date.now(),0),r=setTimeout(t,s);n.addEventListener(()=>{clearTimeout(r),i(U.create("fetch-throttle",{throttleEndTimeMillis:e}))})})}function Cc(n){if(!(n instanceof Ce)||!n.customData)return!1;const e=Number(n.customData.httpStatus);return e===429||e===500||e===503||e===504}class Ec{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function Ic(n,e,t,i,s){if(s&&s.global){n("event",t,i);return}else{const r=await e,o={...i,send_to:r};n("event",t,o)}}async function wc(n,e,t,i){if(i&&i.global){const s={};for(const r of Object.keys(t))s[`user_properties.${r}`]=t[r];return n("set",s),Promise.resolve()}else{const s=await e;n("config",s,{update:!0,user_properties:t})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bc(){if(Ts())try{await Ss()}catch(n){return O.warn(U.create("indexeddb-unavailable",{errorInfo:n?.toString()}).message),!1}else return O.warn(U.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function Tc(n,e,t,i,s,r,o){const a=yc(n);a.then(h=>{t[h.measurementId]=h.appId,n.options.measurementId&&h.measurementId!==n.options.measurementId&&O.warn(`The measurement ID in the local Firebase config (${n.options.measurementId}) does not match the measurement ID fetched from the server (${h.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(h=>O.error(h)),e.push(a);const l=bc().then(h=>{if(h)return i.getId()}),[c,d]=await Promise.all([a,l]);dc(r)||oc(r,c.measurementId),s("js",new Date);const u=o?.config??{};return u[ec]="firebase",u.update=!0,d!=null&&(u[Zl]=d),s("config",c.measurementId,u),c.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sc{constructor(e){this.app=e}_delete(){return delete be[this.app.options.appId],Promise.resolve()}}let be={},ki=[];const Di={};let Yt="dataLayer",Nc="gtag",Pi,xn,xi=!1;function Rc(){const n=[];if(Ho()&&n.push("This is a browser extension environment."),qo()||n.push("Cookies are not available."),n.length>0){const e=n.map((i,s)=>`(${s+1}) ${i}`).join(" "),t=U.create("invalid-analytics-context",{errorInfo:e});O.warn(t.message)}}function Ac(n,e,t){Rc();const i=n.options.appId;if(!i)throw U.create("no-app-id");if(!n.options.apiKey)if(n.options.measurementId)O.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${n.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw U.create("no-api-key");if(be[i]!=null)throw U.create("already-exists",{id:i});if(!xi){ac(Yt);const{wrappedGtag:r,gtagCore:o}=uc(be,ki,Di,Yt,Nc);xn=r,Pi=o,xi=!0}return be[i]=Tc(n,ki,Di,e,Pi,Yt,t),new Sc(n)}function kc(n=Ps()){n=ee(n);const e=nt(n,_t);return e.isInitialized()?e.getImmediate():Dc(n)}function Dc(n,e={}){const t=nt(n,_t);if(t.isInitialized()){const s=t.getImmediate();if(Ke(e,t.getOptions()))return s;throw U.create("already-initialized")}return t.initialize({options:e})}function Pc(n,e,t){n=ee(n),wc(xn,be[n.app.options.appId],e,t).catch(i=>O.error(i))}function xc(n,e,t,i){n=ee(n),Ic(xn,be[n.app.options.appId],e,t,i).catch(s=>O.error(s))}const Oi="@firebase/analytics",Mi="0.10.19";function Oc(){se(new Y(_t,(e,{options:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("installations-internal").getImmediate();return Ac(i,s,t)},"PUBLIC")),se(new Y("analytics-internal",n,"PRIVATE")),q(Oi,Mi),q(Oi,Mi,"esm2020");function n(e){try{const t=e.getProvider(_t).getImmediate();return{logEvent:(i,s,r)=>xc(t,i,s,r),setUserProperties:(i,s)=>Pc(t,i,s)}}catch(t){throw U.create("interop-component-reg-failed",{reason:t})}}}Oc();var Li={};const Fi="@firebase/database",Bi="1.1.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fc{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return Z(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ir=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Lc(e)}}catch{}return new Fc},de=ir("localStorage"),Bc=ir("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xc{constructor(e,t){this.appCheckProvider=t,this.appName=e.name,Ja(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t?.getImmediate({optional:!0}),this.appCheck||t?.get().then(i=>this.appCheck=i)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((t,i)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,i):t(null)},0)})}addTokenChangeListener(e){this.appCheckProvider?.get().then(t=>t.addTokenListener(e))}notifyForInvalidToken(){F(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jc{constructor(e,t,i){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=i,this.auth_=null,this.auth_=i.getImmediate({optional:!0}),this.auth_||i.onInit(s=>this.auth_=s)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(t=>t&&t.code==="auth/token-not-initialized"?(x("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(t)):new Promise((t,i)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(t,i):t(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(t=>t.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(t=>t.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',F(e)}}class ht{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}ht.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eh{constructor(){this.counters_={}}incrementCounter(e,t=1){Z(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return No(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qt={},Xt={};function Ln(n){const e=n.toString();return Qt[e]||(Qt[e]=new eh),Qt[e]}function th(n,e){const t=n.toString();return Xt[t]||(Xt[t]=e()),Xt[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nh{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const i=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let s=0;s<i.length;++s)i[s]&&Me(()=>{this.onMessage_(i[s])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hi="start",ih="close",sh="pLPCommand",rh="pRTLPCB",vr="id",Cr="pw",Er="ser",oh="cb",ah="seg",lh="ts",ch="d",hh="dframe",Ir=1870,wr=30,uh=Ir-wr,dh=25e3,fh=3e4;class we{constructor(e,t,i,s,r,o,a){this.connId=e,this.repoInfo=t,this.applicationId=i,this.appCheckToken=s,this.authToken=r,this.transportSessionId=o,this.lastSessionId=a,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=st(e),this.stats_=Ln(t),this.urlFn=l=>(this.appCheckToken&&(l[dn]=this.appCheckToken),yr(t,mr,l))}open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new nh(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(fh)),$c(()=>{if(this.isClosed_)return;this.scriptTagHolder=new Fn((...r)=>{const[o,a,l,c,d]=r;if(this.incrementIncomingBytes_(r),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===Hi)this.id=a,this.password=l;else if(o===ih)a?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(a,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...r)=>{const[o,a]=r;this.incrementIncomingBytes_(r),this.myPacketOrderer.handleResponse(o,a)},()=>{this.onClosed_()},this.urlFn);const i={};i[Hi]="t",i[Er]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(i[oh]=this.scriptTagHolder.uniqueCallbackIdentifier),i[lr]=Mn,this.transportSessionId&&(i[cr]=this.transportSessionId),this.lastSessionId&&(i[fr]=this.lastSessionId),this.applicationId&&(i[pr]=this.applicationId),this.appCheckToken&&(i[dn]=this.appCheckToken),typeof location<"u"&&location.hostname&&dr.test(location.hostname)&&(i[hr]=ur);const s=this.urlFn(i);this.log_("Connecting via long-poll to "+s),this.scriptTagHolder.addTag(s,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){we.forceAllow_=!0}static forceDisallow(){we.forceDisallow_=!0}static isAvailable(){return we.forceAllow_?!0:!we.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!qc()&&!Gc()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=D(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const i=Cs(t),s=or(i,uh);for(let r=0;r<s.length;r++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,s.length,s[r]),this.curSegmentNum++}addDisconnectPingFrame(e,t){this.myDisconnFrame=document.createElement("iframe");const i={};i[hh]="t",i[vr]=e,i[Cr]=t,this.myDisconnFrame.src=this.urlFn(i),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=D(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}}class Fn{constructor(e,t,i,s){this.onDisconnect=i,this.urlFn=s,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=Uc(),window[sh+this.uniqueCallbackIdentifier]=e,window[rh+this.uniqueCallbackIdentifier]=t,this.myIFrame=Fn.createIFrame_();let r="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(r='<script>document.domain="'+document.domain+'";<\/script>');const o="<html><body>"+r+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(a){x("frame writing exception"),a.stack&&x(a.stack),x(a)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||x("No IE domain setting required")}catch{const i=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+i+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[vr]=this.myID,e[Cr]=this.myPW,e[Er]=this.currentSerial;let t=this.urlFn(e),i="",s=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+wr+i.length<=Ir;){const o=this.pendingSegs.shift();i=i+"&"+ah+s+"="+o.seg+"&"+lh+s+"="+o.ts+"&"+ch+s+"="+o.d,s++}return t=t+i,this.addLongPollTag_(t,this.currentSerial),!0}else return!1}enqueueSegment(e,t,i){this.pendingSegs.push({seg:e,ts:t,d:i}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const i=()=>{this.outstandingRequests.delete(t),this.newRequest_()},s=setTimeout(i,Math.floor(dh)),r=()=>{clearTimeout(s),i()};this.addTag(e,r)}addTag(e,t){setTimeout(()=>{try{if(!this.sendNewPolls)return;const i=this.myIFrame.doc.createElement("script");i.type="text/javascript",i.async=!0,i.src=e,i.onload=i.onreadystatechange=function(){const s=i.readyState;(!s||s==="loaded"||s==="complete")&&(i.onload=i.onreadystatechange=null,i.parentNode&&i.parentNode.removeChild(i),t())},i.onerror=()=>{x("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(i)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xh(n,e){return Oe(n.name,e.name)}function Wn(n,e){return Oe(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let xr,Or;function Mh(n){xr=n}function Lh(n){Or=n}class Fh extends Ot{compare(e,t){const i=e.node.getPriority(),s=t.node.getPriority(),r=i.compareTo(s);return r===0?Oe(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return y.MIN}maxPost(){return new y(me,new A("[PRIORITY-POST]",Or))}makePost(e,t){const i=xr(e);return new y(t,new A("[PRIORITY-POST]",i))}toString(){return".priority"}}const S=new Fh;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bh=Math.log(2);class Uh{constructor(e){const t=r=>parseInt(Math.log(r)/Bh,10),i=r=>parseInt(Array(r+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const s=i(this.count);this.bits_=e+1&s}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const yt=function(n,e,t,i){n.sort(e);const s=function(l,c){const d=c-l;let u,h;if(d===0)return null;if(d===1)return u=n[l],h=t?t(u):u,new k(h,u.node,k.BLACK,null,null);{const p=parseInt(d/2,10)+l,_=s(l,p),E=s(p+1,c);return u=n[p],h=t?t(u):u,new k(h,u.node,k.BLACK,_,E)}},r=function(l){let c=null,d=null,u=n.length;const h=function(_,E){const N=u-_,G=u;u-=_;const z=s(N+1,G),le=n[N],$t=t?t(le):le;p(new k($t,le.node,E,null,z))},p=function(_){c?(c.left=_,c=_):(d=_,c=_)};for(let _=0;_<l.count;++_){const E=l.nextBitIsOne(),N=Math.pow(2,l.count-(_+1));E?h(N,k.BLACK):(h(N,k.BLACK),h(N,k.RED))}return d},o=new Uh(n.length),a=r(o);return new L(i||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hh=!0;function P(n,e=null){if(n===null)return m.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),f(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new A(t,P(e))}if(!(n instanceof Array)&&Hh){const t=[];let i=!1;if(B(n,(o,a)=>{if(o.substring(0,1)!=="."){const l=P(a);l.isEmpty()||(i=i||!l.getPriority().isEmpty(),t.push(new y(o,l)))}}),t.length===0)return m.EMPTY_NODE;const r=yt(t,xh,o=>o.name,Wn);if(i){const o=yt(t,S.getCompare());return new m(r,P(e),new j({".priority":o},{".priority":S}))}else return new m(r,P(e),j.Default)}else{let t=m.EMPTY_NODE;return B(n,(i,s)=>{if(Z(n,i)&&i.substring(0,1)!=="."){const r=P(s);(r.isLeafNode()||!r.isEmpty())&&(t=t.updateImmediateChild(i,r))}}),t.updatePriority(P(e))}}Mh(P);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vh extends Ot{compare(e,t){const i=e.node.compareTo(t.node);return i===0?Oe(e.name,t.name):i}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return y.MIN}maxPost(){return y.MAX}makePost(e,t){const i=P(e);return new y(t,i)}toString(){return".value"}}const qh=new Vh;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mr(n){return{type:"value",snapshotNode:n}}function ke(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function Xe(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function Je(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function Gh(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qh{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t={...e};return this.last_&&B(this.last_,(i,s)=>{t[i]=t[i]-s}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ts=10*1e3,Xh=30*1e3,Jh=300*1e3;class Zh{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Qh(e);const i=ts+(Xh-ts)*Math.random();Ve(this.reportStats_.bind(this),Math.floor(i))}reportStats_(){const e=this.statsListener_.get(),t={};let i=!1;B(e,(s,r)=>{r>0&&Z(this.statsToReport_,s)&&(t[s]=r,i=!0)}),i&&this.server_.reportStats(t),Ve(this.reportStats_.bind(this),Math.floor(Math.random()*2*Jh))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eu{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function tu(n,e,t,i){const s=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(Gh(o.childName,o.snapshotNode))}),We(n,s,"child_removed",e,i,t),We(n,s,"child_added",e,i,t),We(n,s,"child_moved",r,i,t),We(n,s,"child_changed",e,i,t),We(n,s,"value",e,i,t),s}function We(n,e,t,i,s,r){const o=i.filter(a=>a.type===t);o.sort((a,l)=>iu(n,a,l)),o.forEach(a=>{const l=nu(n,a,r);s.forEach(c=>{c.respondsTo(a.type)&&e.push(c.createEvent(l,n.query_))})})}function nu(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function iu(n,e,t){if(e.childName==null||t.childName==null)throw xe("Should only compare child_ events.");const i=new y(e.childName,e.snapshotNode),s=new y(t.childName,t.snapshotNode);return n.index_.compare(i,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gn(n,e){return Vr(e,n)}function ru(n,e,t,i,s){f(i>n.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),n.allWrites.push({path:e,snap:t,writeId:i,visible:s}),s&&(n.visibleWrites=Ge(n.visibleWrites,e,t)),n.lastWriteId=i}function ou(n,e){for(let t=0;t<n.allWrites.length;t++){const i=n.allWrites[t];if(i.writeId===e)return i}return null}function au(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);f(t>=0,"removeWrite called with nonexistent writeId.");const i=n.allWrites[t];n.allWrites.splice(t,1);let s=i.visible,r=!1,o=n.allWrites.length-1;for(;s&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&lu(a,i.path)?s=!1:H(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return cu(n),!0;if(i.snap)n.visibleWrites=is(n.visibleWrites,i.path);else{const a=i.children;B(a,l=>{n.visibleWrites=is(n.visibleWrites,R(i.path,l))})}return!0}else return!1}function lu(n,e){if(n.snap)return H(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&H(R(n.path,t),e))return!0;return!1}function cu(n){n.visibleWrites=Wr(n.allWrites,hu,C()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function hu(n){return n.visible}function Wr(n,e,t){let i=V.empty();for(let s=0;s<n.length;++s){const r=n[s];if(e(r)){const o=r.path;let a;if(r.snap)H(t,o)?(a=M(t,o),i=Ge(i,a,r.snap)):H(o,t)&&(a=M(o,t),i=Ge(i,C(),r.snap.getChild(a)));else if(r.children){if(H(t,o))a=M(t,o),i=ns(i,a,r.children);else if(H(o,t))if(a=M(o,t),v(a))i=ns(i,C(),r.children);else{const l=Re(r.children,g(a));if(l){const c=l.getChild(b(a));i=Ge(i,C(),c)}}}else throw xe("WriteRecord should have .snap or .children")}}return i}function Hr(n,e,t,i,s){if(!i&&!s){const r=Ee(n.visibleWrites,e);if(r!=null)return r;{const o=ie(n.visibleWrites,e);if(gn(o))return t;if(t==null&&!mn(o,C()))return null;{const a=t||m.EMPTY_NODE;return De(o,a)}}}else{const r=ie(n.visibleWrites,e);if(!s&&gn(r))return t;if(!s&&t==null&&!mn(r,C()))return null;{const o=function(c){return(c.visible||s)&&(!i||!~i.indexOf(c.writeId))&&(H(c.path,e)||H(e,c.path))},a=Wr(n.allWrites,o,e),l=t||m.EMPTY_NODE;return De(a,l)}}}function uu(n,e,t){let i=m.EMPTY_NODE;const s=Ee(n.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(S,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(t){const r=ie(n.visibleWrites,e);return t.forEachChild(S,(o,a)=>{const l=De(ie(r,new I(o)),a);i=i.updateImmediateChild(o,l)}),ss(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=ie(n.visibleWrites,e);return ss(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function du(n,e,t,i,s){f(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=R(e,t);if(mn(n.visibleWrites,r))return null;{const o=ie(n.visibleWrites,r);return gn(o)?s.getChild(t):De(o,s.getChild(t))}}function fu(n,e,t,i){const s=R(e,t),r=Ee(n.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(t)){const o=ie(n.visibleWrites,s);return De(o,i.getNode().getImmediateChild(t))}else return null}function pu(n,e){return Ee(n.visibleWrites,e)}function _u(n,e,t,i,s,r,o){let a;const l=ie(n.visibleWrites,e),c=Ee(l,C());if(c!=null)a=c;else if(t!=null)a=De(l,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const d=[],u=o.getCompare(),h=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let p=h.getNext();for(;p&&d.length<s;)u(p,i)!==0&&d.push(p),p=h.getNext();return d}else return[]}function mu(){return{visibleWrites:V.empty(),allWrites:[],lastWriteId:-1}}function It(n,e,t,i){return Hr(n.writeTree,n.treePath,e,t,i)}function zn(n,e){return uu(n.writeTree,n.treePath,e)}function rs(n,e,t,i){return du(n.writeTree,n.treePath,e,t,i)}function wt(n,e){return pu(n.writeTree,R(n.treePath,e))}function gu(n,e,t,i,s,r){return _u(n.writeTree,n.treePath,e,t,i,s,r)}function jn(n,e,t){return fu(n.writeTree,n.treePath,e,t)}function $r(n,e){return Vr(R(n.treePath,e),n.writeTree)}function Vr(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vu{getCompleteChild(e){return null}getChildAfterChild(e,t,i){return null}}const qr=new vu;class Kn{constructor(e,t,i=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=i}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new ye(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return jn(this.writes_,e,i)}}getChildAfterChild(e,t,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:ve(this.viewCache_),r=gu(this.writes_,s,t,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ru{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const i=this.query_._queryParams,s=new Hn(i.getIndex()),r=jh(i);this.processor_=Cu(r);const o=t.serverCache,a=t.eventCache,l=s.updateFullNode(m.EMPTY_NODE,o.getNode(),null),c=r.updateFullNode(m.EMPTY_NODE,a.getNode(),null),d=new ye(l,o.isFullyInitialized(),s.filtersNodes()),u=new ye(c,a.isFullyInitialized(),r.filtersNodes());this.viewCache_=Mt(u,d),this.eventGenerator_=new eu(this.query_)}get query(){return this.query_}}function Au(n){return n.viewCache_.serverCache.getNode()}function ku(n,e){const t=ve(n.viewCache_);return t&&(n.query._queryParams.loadsAllData()||!v(e)&&!t.getImmediateChild(g(e)).isEmpty())?t.getChild(e):null}function ls(n){return n.eventRegistrations_.length===0}function Du(n,e){n.eventRegistrations_.push(e)}function cs(n,e,t){const i=[];if(t){f(e==null,"A cancel should cancel all event registrations.");const s=n.query._path;n.eventRegistrations_.forEach(r=>{const o=r.createCancelEvent(t,s);o&&i.push(o)})}if(e){let s=[];for(let r=0;r<n.eventRegistrations_.length;++r){const o=n.eventRegistrations_[r];if(!o.matches(e))s.push(o);else if(e.hasAnyCallback()){s=s.concat(n.eventRegistrations_.slice(r+1));break}}n.eventRegistrations_=s}else n.eventRegistrations_=[];return i}function hs(n,e,t,i){e.type===$.MERGE&&e.source.queryId!==null&&(f(ve(n.viewCache_),"We should always have a full cache before handling merges"),f(_n(n.viewCache_),"Missing event cache, even though we have a server cache"));const s=n.viewCache_,r=Iu(n.processor_,s,e,t,i);return Eu(n.processor_,r.viewCache),f(r.viewCache.serverCache.isFullyInitialized()||!s.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),n.viewCache_=r.viewCache,zr(n,r.changes,r.viewCache.eventCache.getNode(),null)}function Pu(n,e){const t=n.viewCache_.eventCache,i=[];return t.getNode().isLeafNode()||t.getNode().forEachChild(S,(r,o)=>{i.push(ke(r,o))}),t.isFullyInitialized()&&i.push(Mr(t.getNode())),zr(n,i,t.getNode(),e)}function zr(n,e,t,i){const s=i?[i]:n.eventRegistrations_;return tu(n.eventGenerator_,e,t,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Tt;class xu{constructor(){this.views=new Map}}function Ou(n){f(!Tt,"__referenceConstructor has already been defined"),Tt=n}function Mu(){return f(Tt,"Reference.ts has not been loaded"),Tt}function Lu(n){return n.views.size===0}function Yn(n,e,t,i){const s=e.source.queryId;if(s!==null){const r=n.views.get(s);return f(r!=null,"SyncTree gave us an op for an invalid query."),hs(r,e,t,i)}else{let r=[];for(const o of n.views.values())r=r.concat(hs(o,e,t,i));return r}}function Fu(n,e,t,i,s){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let a=It(t,s?i:null),l=!1;a?l=!0:i instanceof m?(a=zn(t,i),l=!1):(a=m.EMPTY_NODE,l=!1);const c=Mt(new ye(a,l,!1),new ye(i,s,!1));return new Ru(e,c)}return o}function Bu(n,e,t,i,s,r){const o=Fu(n,e,i,s,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),Du(o,t),Pu(o,t)}function Uu(n,e,t,i){const s=e._queryIdentifier,r=[];let o=[];const a=oe(n);if(s==="default")for(const[l,c]of n.views.entries())o=o.concat(cs(c,t,i)),ls(c)&&(n.views.delete(l),c.query._queryParams.loadsAllData()||r.push(c.query));else{const l=n.views.get(s);l&&(o=o.concat(cs(l,t,i)),ls(l)&&(n.views.delete(s),l.query._queryParams.loadsAllData()||r.push(l.query)))}return a&&!oe(n)&&r.push(new(Mu())(e._repo,e._path)),{removed:r,events:o}}function jr(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function Ne(n,e){let t=null;for(const i of n.views.values())t=t||ku(i,e);return t}function Kr(n,e){if(e._queryParams.loadsAllData())return Lt(n);{const i=e._queryIdentifier;return n.views.get(i)}}function Yr(n,e){return Kr(n,e)!=null}function oe(n){return Lt(n)!=null}function Lt(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let St;function Wu(n){f(!St,"__referenceConstructor has already been defined"),St=n}function Hu(){return f(St,"Reference.ts has not been loaded"),St}let $u=1;class us{constructor(e){this.listenProvider_=e,this.syncPointTree_=new T(null),this.pendingWriteTree_=mu(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Qr(n,e,t,i,s){return ru(n.pendingWriteTree_,e,t,i,s),s?ot(n,new ge(Fr(),e,t)):[]}function fe(n,e,t=!1){const i=ou(n.pendingWriteTree_,e);if(au(n.pendingWriteTree_,e)){let r=new T(null);return i.snap!=null?r=r.set(C(),!0):B(i.children,o=>{r=r.set(new I(o),!0)}),ot(n,new Et(i.path,r,t))}else return[]}function Ft(n,e,t){return ot(n,new ge(Vn(),e,t))}function Vu(n,e,t){const i=T.fromObject(t);return ot(n,new tt(Vn(),e,i))}function qu(n,e){return ot(n,new et(Vn(),e))}function Gu(n,e,t){const i=Xn(n,t);if(i){const s=Jn(i),r=s.path,o=s.queryId,a=M(r,e),l=new et(qn(o),a);return Zn(n,r,l)}else return[]}function Cn(n,e,t,i,s=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||Yr(o,e))){const l=Uu(o,e,t,i);Lu(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!s){const d=c.findIndex(h=>h._queryParams.loadsAllData())!==-1,u=n.syncPointTree_.findOnPath(r,(h,p)=>oe(p));if(d&&!u){const h=n.syncPointTree_.subtree(r);if(!h.isEmpty()){const p=Ku(h);for(let _=0;_<p.length;++_){const E=p[_],N=E.query,G=Zr(n,E);n.listenProvider_.startListening(ze(N),Nt(n,N),G.hashFn,G.onComplete)}}}!u&&c.length>0&&!i&&(d?n.listenProvider_.stopListening(ze(e),null):c.forEach(h=>{const p=n.queryToTagMap.get(Bt(h));n.listenProvider_.stopListening(ze(h),p)}))}Yu(n,c)}return a}function zu(n,e,t,i){const s=Xn(n,i);if(s!=null){const r=Jn(s),o=r.path,a=r.queryId,l=M(o,e),c=new ge(qn(a),l,t);return Zn(n,o,c)}else return[]}function ju(n,e,t,i){const s=Xn(n,i);if(s){const r=Jn(s),o=r.path,a=r.queryId,l=M(o,e),c=T.fromObject(t),d=new tt(qn(a),l,c);return Zn(n,o,d)}else return[]}function ds(n,e,t,i=!1){const s=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(s,(h,p)=>{const _=M(h,s);r=r||Ne(p,_),o=o||oe(p)});let a=n.syncPointTree_.get(s);a?(o=o||oe(a),r=r||Ne(a,C())):(a=new xu,n.syncPointTree_=n.syncPointTree_.set(s,a));let l;r!=null?l=!0:(l=!1,r=m.EMPTY_NODE,n.syncPointTree_.subtree(s).foreachChild((p,_)=>{const E=Ne(_,C());E&&(r=r.updateImmediateChild(p,E))}));const c=Yr(a,e);if(!c&&!e._queryParams.loadsAllData()){const h=Bt(e);f(!n.queryToTagMap.has(h),"View does not exist, but we have a tag");const p=Qu();n.queryToTagMap.set(h,p),n.tagToQueryMap.set(p,h)}const d=Gn(n.pendingWriteTree_,s);let u=Bu(a,e,t,d,r,l);if(!c&&!o&&!i){const h=Kr(a,e);u=u.concat(Xu(n,e,h))}return u}function Qn(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const l=M(o,e),c=Ne(a,l);if(c)return c});return Hr(s,e,r,t,!0)}function ot(n,e){return Xr(e,n.syncPointTree_,null,Gn(n.pendingWriteTree_,C()))}function Xr(n,e,t,i){if(v(n.path))return Jr(n,e,t,i);{const s=e.get(C());t==null&&s!=null&&(t=Ne(s,C()));let r=[];const o=g(n.path),a=n.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,d=$r(i,o);r=r.concat(Xr(a,l,c,d))}return s&&(r=r.concat(Yn(s,n,i,t))),r}}function Jr(n,e,t,i){const s=e.get(C());t==null&&s!=null&&(t=Ne(s,C()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=$r(i,o),d=n.operationForChild(o);d&&(r=r.concat(Jr(d,a,l,c)))}),s&&(r=r.concat(Yn(s,n,i,t))),r}function Zr(n,e){const t=e.query,i=Nt(n,t);return{hashFn:()=>(Au(e)||m.EMPTY_NODE).hash(),onComplete:s=>{if(s==="ok")return i?Gu(n,t._path,i):qu(n,t._path);{const r=zc(s,t);return Cn(n,t,null,r)}}}}function Nt(n,e){const t=Bt(e);return n.queryToTagMap.get(t)}function Bt(n){return n._path.toString()+"$"+n._queryIdentifier}function Xn(n,e){return n.tagToQueryMap.get(e)}function Jn(n){const e=n.indexOf("$");return f(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new I(n.substr(0,e))}}function Zn(n,e,t){const i=n.syncPointTree_.get(e);f(i,"Missing sync point for query tag that we're tracking");const s=Gn(n.pendingWriteTree_,e);return Yn(i,t,s,null)}function Ku(n){return n.fold((e,t,i)=>{if(t&&oe(t))return[Lt(t)];{let s=[];return t&&(s=jr(t)),B(i,(r,o)=>{s=s.concat(o)}),s}})}function ze(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(Hu())(n._repo,n._path):n}function Yu(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const s=Bt(i),r=n.queryToTagMap.get(s);n.queryToTagMap.delete(s),n.tagToQueryMap.delete(r)}}}function Qu(){return $u++}function Xu(n,e,t){const i=e._path,s=Nt(n,e),r=Zr(n,t),o=n.listenProvider_.startListening(ze(e),s,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(i);if(s)f(!oe(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,d,u)=>{if(!v(c)&&d&&oe(d))return[Lt(d).query];{let h=[];return d&&(h=h.concat(jr(d).map(p=>p.query))),B(u,(p,_)=>{h=h.concat(_)}),h}});for(let c=0;c<l.length;++c){const d=l[c];n.listenProvider_.stopListening(ze(d),Nt(n,d))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ei{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new ei(t)}node(){return this.node_}}class ti{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=R(this.path_,e);return new ti(this.syncTree_,t)}node(){return Qn(this.syncTree_,this.path_)}}const Ju=function(n){return n=n||{},n.timestamp=n.timestamp||new Date().getTime(),n},fs=function(n,e,t){if(!n||typeof n!="object")return n;if(f(".sv"in n,"Unexpected leaf node or priority contents"),typeof n[".sv"]=="string")return Zu(n[".sv"],e,t);if(typeof n[".sv"]=="object")return ed(n[".sv"],e);f(!1,"Unexpected server value: "+JSON.stringify(n,null,2))},Zu=function(n,e,t){switch(n){case"timestamp":return t.timestamp;default:f(!1,"Unexpected server value: "+n)}},ed=function(n,e,t){n.hasOwnProperty("increment")||f(!1,"Unexpected server value: "+JSON.stringify(n,null,2));const i=n.increment;typeof i!="number"&&f(!1,"Unexpected increment value: "+i);const s=e.node();if(f(s!==null&&typeof s<"u","Expected ChildrenNode.EMPTY_NODE for nulls"),!s.isLeafNode())return i;const o=s.getValue();return typeof o!="number"?i:o+i},td=function(n,e,t,i){return ni(e,new ti(t,n),i)},eo=function(n,e,t){return ni(n,new ei(e),t)};function ni(n,e,t){const i=n.getPriority().val(),s=fs(i,e.getImmediateChild(".priority"),t);let r;if(n.isLeafNode()){const o=n,a=fs(o.getValue(),e,t);return a!==o.getValue()||s!==o.getPriority().val()?new A(a,P(s)):n}else{const o=n;return r=o,s!==o.getPriority().val()&&(r=r.updatePriority(new A(s))),o.forEachChild(S,(a,l)=>{const c=ni(l,e.getImmediateChild(a),t);c!==l&&(r=r.updateImmediateChild(a,c))}),r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rd=/[\[\].#$\/\u0000-\u001F\u007F]/,od=/[\[\].#$\u0000-\u001F\u007F]/,tn=10*1024*1024,so=function(n){return typeof n=="string"&&n.length!==0&&!rd.test(n)},ro=function(n){return typeof n=="string"&&n.length!==0&&!od.test(n)},ad=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),ro(n)},oo=function(n,e,t,i){i&&e===void 0||ri(Tn(n,"value"),e,t)},ri=function(n,e,t){const i=t instanceof I?new Th(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+he(i));if(typeof e=="function")throw new Error(n+"contains a function "+he(i)+" with contents = "+e.toString());if(rr(e))throw new Error(n+"contains "+e.toString()+" "+he(i));if(typeof e=="string"&&e.length>tn/3&&Dt(e)>tn)throw new Error(n+"contains a string greater than "+tn+" utf8 bytes "+he(i)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let s=!1,r=!1;if(B(e,(o,a)=>{if(o===".value")s=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!so(o)))throw new Error(n+" contains an invalid key ("+o+") "+he(i)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);Sh(i,o),ri(n,a,i),Nh(i)}),s&&r)throw new Error(n+' contains ".value" child '+he(i)+" in addition to actual children.")}},ao=function(n,e,t,i){if(!ro(t))throw new Error(Tn(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},ld=function(n,e,t,i){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),ao(n,e,t)},lo=function(n,e){if(g(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},cd=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!so(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!ad(t))throw new Error(Tn(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hd{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function oi(n,e){let t=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();t!==null&&!Bn(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(s)}t&&n.eventLists_.push(t)}function co(n,e,t){oi(n,t),ho(n,i=>Bn(i,e))}function J(n,e,t){oi(n,t),ho(n,i=>H(i,e)||H(e,i))}function ho(n,e){n.recursionDepth_++;let t=!0;for(let i=0;i<n.eventLists_.length;i++){const s=n.eventLists_[i];if(s){const r=s.path;e(r)?(ud(n.eventLists_[i]),n.eventLists_[i]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function ud(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const i=t.getEventRunner();$e&&x("event: "+t.toString()),Me(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dd="repo_interrupt",fd=25;class pd{constructor(e,t,i,s){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=i,this.appCheckProvider_=s,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new hd,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=Ct(),this.transactionQueueTree_=new ii,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function _d(n,e,t){if(n.stats_=Ln(n.repoInfo_),n.forceRestClient_||Qc())n.server_=new vt(n.repoInfo_,(i,s,r,o)=>{ps(n,i,s,r,o)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>_s(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{D(t)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}n.persistentConnection_=new K(n.repoInfo_,e,(i,s,r,o)=>{ps(n,i,s,r,o)},i=>{_s(n,i)},i=>{md(n,i)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(i=>{n.server_.refreshAuthToken(i)}),n.appCheckProvider_.addTokenChangeListener(i=>{n.server_.refreshAppCheckToken(i.token)}),n.statsReporter_=th(n.repoInfo_,()=>new Zh(n.stats_,n.server_)),n.infoData_=new Kh,n.infoSyncTree_=new us({startListening:(i,s,r,o)=>{let a=[];const l=n.infoData_.getNode(i._path);return l.isEmpty()||(a=Ft(n.infoSyncTree_,i._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),li(n,"connected",!1),n.serverSyncTree_=new us({startListening:(i,s,r,o)=>(n.server_.listen(i,r,s,(a,l)=>{const c=o(a,l);J(n.eventQueue_,i._path,c)}),[]),stopListening:(i,s)=>{n.server_.unlisten(i,s)}})}function uo(n){const t=n.infoData_.getNode(new I(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function ai(n){return Ju({timestamp:uo(n)})}function ps(n,e,t,i,s){n.dataUpdateCount++;const r=new I(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let o=[];if(s)if(i){const l=dt(t,c=>P(c));o=ju(n.serverSyncTree_,r,l,s)}else{const l=P(t);o=zu(n.serverSyncTree_,r,l,s)}else if(i){const l=dt(t,c=>P(c));o=Vu(n.serverSyncTree_,r,l)}else{const l=P(t);o=Ft(n.serverSyncTree_,r,l)}let a=r;o.length>0&&(a=Wt(n,r)),J(n.eventQueue_,a,o)}function _s(n,e){li(n,"connected",e),e===!1&&yd(n)}function md(n,e){B(e,(t,i)=>{li(n,t,i)})}function li(n,e,t){const i=new I("/.info/"+e),s=P(t);n.infoData_.updateSnapshot(i,s);const r=Ft(n.infoSyncTree_,i,s);J(n.eventQueue_,i,r)}function fo(n){return n.nextWriteId_++}function gd(n,e,t,i,s){ci(n,"set",{path:e.toString(),value:t,priority:i});const r=ai(n),o=P(t,i),a=Qn(n.serverSyncTree_,e),l=eo(o,a,r),c=fo(n),d=Qr(n.serverSyncTree_,e,l,c,!0);oi(n.eventQueue_,d),n.server_.put(e.toString(),o.val(!0),(h,p)=>{const _=h==="ok";_||F("set at "+e+" failed: "+h);const E=fe(n.serverSyncTree_,c,!_);J(n.eventQueue_,e,E),Id(n,s,h,p)});const u=yo(n,e);Wt(n,u),J(n.eventQueue_,u,[])}function yd(n){ci(n,"onDisconnectEvents");const e=ai(n),t=Ct();pn(n.onDisconnect_,C(),(s,r)=>{const o=td(s,r,n.serverSyncTree_,e);Lr(t,s,o)});let i=[];pn(t,C(),(s,r)=>{i=i.concat(Ft(n.serverSyncTree_,s,r));const o=yo(n,s);Wt(n,o)}),n.onDisconnect_=Ct(),J(n.eventQueue_,C(),i)}function vd(n,e,t){let i;g(e._path)===".info"?i=ds(n.infoSyncTree_,e,t):i=ds(n.serverSyncTree_,e,t),co(n.eventQueue_,e._path,i)}function Cd(n,e,t){let i;g(e._path)===".info"?i=Cn(n.infoSyncTree_,e,t):i=Cn(n.serverSyncTree_,e,t),co(n.eventQueue_,e._path,i)}function Ed(n){n.persistentConnection_&&n.persistentConnection_.interrupt(dd)}function ci(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),x(t,...e)}function Id(n,e,t,i){e&&Me(()=>{if(t==="ok")e(null);else{const s=(t||"error").toUpperCase();let r=s;i&&(r+=": "+i);const o=new Error(r);o.code=s,e(o)}})}function po(n,e,t){return Qn(n.serverSyncTree_,e,t)||m.EMPTY_NODE}function hi(n,e=n.transactionQueueTree_){if(e||Ht(n,e),Le(e)){const t=mo(n,e);f(t.length>0,"Sending zero length transaction queue"),t.every(s=>s.status===0)&&wd(n,at(e),t)}else no(e)&&Ut(e,t=>{hi(n,t)})}function wd(n,e,t){const i=t.map(c=>c.currentWriteId),s=po(n,e,i);let r=s;const o=s.hash();for(let c=0;c<t.length;c++){const d=t[c];f(d.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),d.status=1,d.retryCount++;const u=M(e,d.path);r=r.updateChild(u,d.currentOutputSnapshotRaw)}const a=r.val(!0),l=e;n.server_.put(l.toString(),a,c=>{ci(n,"transaction put response",{path:l.toString(),status:c});let d=[];if(c==="ok"){const u=[];for(let h=0;h<t.length;h++)t[h].status=2,d=d.concat(fe(n.serverSyncTree_,t[h].currentWriteId)),t[h].onComplete&&u.push(()=>t[h].onComplete(null,!0,t[h].currentOutputSnapshotResolved)),t[h].unwatcher();Ht(n,si(n.transactionQueueTree_,e)),hi(n,n.transactionQueueTree_),J(n.eventQueue_,e,d);for(let h=0;h<u.length;h++)Me(u[h])}else{if(c==="datastale")for(let u=0;u<t.length;u++)t[u].status===3?t[u].status=4:t[u].status=0;else{F("transaction at "+l.toString()+" failed: "+c);for(let u=0;u<t.length;u++)t[u].status=4,t[u].abortReason=c}Wt(n,e)}},o)}function Wt(n,e){const t=_o(n,e),i=at(t),s=mo(n,t);return bd(n,s,i),i}function bd(n,e,t){if(e.length===0)return;const i=[];let s=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=M(t,l.path);let d=!1,u;if(f(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)d=!0,u=l.abortReason,s=s.concat(fe(n.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=fd)d=!0,u="maxretry",s=s.concat(fe(n.serverSyncTree_,l.currentWriteId,!0));else{const h=po(n,l.path,o);l.currentInputSnapshot=h;const p=e[a].update(h.val());if(p!==void 0){ri("transaction failed: Data returned ",p,l.path);let _=P(p);typeof p=="object"&&p!=null&&Z(p,".priority")||(_=_.updatePriority(h.getPriority()));const N=l.currentWriteId,G=ai(n),z=eo(_,h,G);l.currentOutputSnapshotRaw=_,l.currentOutputSnapshotResolved=z,l.currentWriteId=fo(n),o.splice(o.indexOf(N),1),s=s.concat(Qr(n.serverSyncTree_,l.path,z,l.currentWriteId,l.applyLocally)),s=s.concat(fe(n.serverSyncTree_,N,!0))}else d=!0,u="nodata",s=s.concat(fe(n.serverSyncTree_,l.currentWriteId,!0))}J(n.eventQueue_,t,s),s=[],d&&(e[a].status=2,(function(h){setTimeout(h,Math.floor(0))})(e[a].unwatcher),e[a].onComplete&&(u==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(u),!1,null))))}Ht(n,n.transactionQueueTree_);for(let a=0;a<i.length;a++)Me(i[a]);hi(n,n.transactionQueueTree_)}function _o(n,e){let t,i=n.transactionQueueTree_;for(t=g(e);t!==null&&Le(i)===void 0;)i=si(i,t),e=b(e),t=g(e);return i}function mo(n,e){const t=[];return go(n,e,t),t.sort((i,s)=>i.order-s.order),t}function go(n,e,t){const i=Le(e);if(i)for(let s=0;s<i.length;s++)t.push(i[s]);Ut(e,s=>{go(n,s,t)})}function Ht(n,e){const t=Le(e);if(t){let i=0;for(let s=0;s<t.length;s++)t[s].status!==2&&(t[i]=t[s],i++);t.length=i,to(e,t.length>0?t:void 0)}Ut(e,i=>{Ht(n,i)})}function yo(n,e){const t=at(_o(n,e)),i=si(n.transactionQueueTree_,e);return id(i,s=>{nn(n,s)}),nn(n,i),io(i,s=>{nn(n,s)}),t}function nn(n,e){const t=Le(e);if(t){const i=[];let s=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(f(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(f(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),s=s.concat(fe(n.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&i.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?to(e,void 0):t.length=r+1,J(n.eventQueue_,at(e),s);for(let o=0;o<i.length;o++)Me(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Td(n){let e="";const t=n.split("/");for(let i=0;i<t.length;i++)if(t[i].length>0){let s=t[i];try{s=decodeURIComponent(s.replace(/\+/g," "))}catch{}e+="/"+s}return e}function Sd(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const i=t.split("=");i.length===2?e[decodeURIComponent(i[0])]=decodeURIComponent(i[1]):F(`Invalid query segment '${t}' in query '${n}'`)}return e}const ms=function(n,e){const t=Nd(n),i=t.namespace;t.domain==="firebase.com"&&X(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!i||i==="undefined")&&t.domain!=="localhost"&&X("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||Hc();const s=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new gr(t.host,t.secure,i,s,e,"",i!==t.subdomain),path:new I(t.pathString)}},Nd=function(n){let e="",t="",i="",s="",r="",o=!0,a="https",l=443;if(typeof n=="string"){let c=n.indexOf("//");c>=0&&(a=n.substring(0,c-1),n=n.substring(c+2));let d=n.indexOf("/");d===-1&&(d=n.length);let u=n.indexOf("?");u===-1&&(u=n.length),e=n.substring(0,Math.min(d,u)),d<u&&(s=Td(n.substring(d,u)));const h=Sd(n.substring(Math.min(n.length,u)));c=e.indexOf(":"),c>=0?(o=a==="https"||a==="wss",l=parseInt(e.substring(c+1),10)):c=e.length;const p=e.slice(0,c);if(p.toLowerCase()==="localhost")t="localhost";else if(p.split(".").length<=2)t=p;else{const _=e.indexOf(".");i=e.substring(0,_).toLowerCase(),t=e.substring(_+1),r=i}"ns"in h&&(r=h.ns)}return{host:e,port:l,domain:t,subdomain:i,secure:o,scheme:a,pathString:s,namespace:r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ad{constructor(e,t,i,s){this.eventType=e,this.eventRegistration=t,this.snapshot=i,this.prevName=s}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+D(this.snapshot.exportVal())}}class kd{constructor(e,t,i){this.eventRegistration=e,this.error=t,this.path=i}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ui{constructor(e,t,i,s){this._repo=e,this._path=t,this._queryParams=i,this._orderByCalled=s}get key(){return v(this._path)?null:Sr(this._path)}get ref(){return new ae(this._repo,this._path)}get _queryIdentifier(){const e=es(this._queryParams),t=On(e);return t==="{}"?"default":t}get _queryObject(){return es(this._queryParams)}isEqual(e){if(e=ee(e),!(e instanceof ui))return!1;const t=this._repo===e._repo,i=Bn(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return t&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+bh(this._path)}}class ae extends ui{constructor(e,t){super(e,t,new $n,!1)}get parent(){const e=Rr(this._path);return e===null?null:new ae(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Rt{constructor(e,t,i){this._node=e,this.ref=t,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new I(e),i=Pe(this.ref,e);return new Rt(this._node.getChild(t),i,S)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new Rt(s,Pe(this.ref,i),S)))}hasChild(e){const t=new I(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function di(n,e){return n=ee(n),n._checkNotDeleted("ref"),e!==void 0?Pe(n._root,e):n._root}function Pe(n,e){return n=ee(n),g(n._path)===null?ld("child","path",e):ao("child","path",e),new ae(n._repo,R(n._path,e))}function Pd(n,e){n=ee(n),lo("push",n._path),oo("push",e,n._path,!0);const t=uo(n._repo),i=Rd(t),s=Pe(n,i),r=Pe(n,i);let o;return o=Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}function vo(n,e){n=ee(n),lo("set",n._path),oo("set",e,n._path,!1);const t=new At;return gd(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}class fi{constructor(e,t){this.eventType=e,this.callbackContext=t}respondsTo(e){let t=e==="children_added"?"child_added":e;return t=t==="children_removed"?"child_removed":t,this.eventType===t}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new kd(this,e,t):null}createEvent(e,t){f(e.childName!=null,"Child events should have a childName.");const i=Pe(new ae(t._repo,t._path),e.childName),s=t._queryParams.getIndex();return new Ad(e.type,this,new Rt(e.snapshotNode,i,s),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof fi?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function xd(n,e,t,i,s){const r=new Dd(t,void 0),o=new fi(e,r);return vd(n._repo,n,o),()=>Cd(n._repo,n,o)}function Od(n,e,t,i){return xd(n,"child_added",e)}Ou(ae);Wu(ae);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Md="FIREBASE_DATABASE_EMULATOR_HOST",In={};let Ld=!1;function Fd(n,e,t,i){const s=e.lastIndexOf(":"),r=e.substring(0,s),o=bn(r);n.repoInfo_=new gr(e,o,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),i&&(n.authTokenProvider_=i)}function Bd(n,e,t,i,s){let r=i||n.options.databaseURL;r===void 0&&(n.options.projectId||X("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),x("Using default host for project ",n.options.projectId),r=`${n.options.projectId}-default-rtdb.firebaseio.com`);let o=ms(r,s),a=o.repoInfo,l;typeof process<"u"&&Li&&(l=Li[Md]),l?(r=`http://${l}?ns=${a.namespace}`,o=ms(r,s),a=o.repoInfo):o.repoInfo.secure;const c=new Jc(n.name,n.options,e);cd("Invalid Firebase Database URL",o),v(o.path)||X("Database URL must point to the root of a Firebase Database (not including a child path).");const d=Wd(a,n,c,new Xc(n,t));return new Hd(d,n)}function Ud(n,e){const t=In[e];(!t||t[n.key]!==n)&&X(`Database ${e}(${n.repoInfo_}) has already been deleted.`),Ed(n),delete t[n.key]}function Wd(n,e,t,i){let s=In[e.name];s||(s={},In[e.name]=s);let r=s[n.toURLString()];return r&&X("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new pd(n,Ld,t,i),s[n.toURLString()]=r,r}class Hd{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(_d(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new ae(this._repo,C())),this._rootInternal}_delete(){return this._rootInternal!==null&&(Ud(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&X("Cannot call "+e+" on a deleted database.")}}function $d(n=Ps(),e){const t=nt(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const i=Oo("database");i&&Vd(t,...i)}return t}function Vd(n,e,t,i={}){n=ee(n),n._checkNotDeleted("useEmulator");const s=`${e}:${t}`,r=n._repoInternal;if(n._instanceStarted){if(s===n._repoInternal.repoInfo_.host&&Ke(i,r.repoInfo_.emulatorOptions))return;X("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let o;if(r.repoInfo_.nodeAdmin)i.mockUserToken&&X('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new ht(ht.OWNER);else if(i.mockUserToken){const a=typeof i.mockUserToken=="string"?i.mockUserToken:Lo(i.mockUserToken,n.app.options.projectId);o=new ht(a)}bn(e)&&(Mo(e),Uo("Database",!0)),Fd(r,s,i,o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qd(n){Mc(tl),se(new Y("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Bd(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),q(Fi,Bi,n),q(Fi,Bi,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gd={".sv":"timestamp"};function Co(){return Gd}K.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};K.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};qd();const zd={apiKey:"AIzaSyD9821q_YpfGHH9ZFPBXgVXQSyxbAfSGvk",authDomain:"aera-3f59e.firebaseapp.com",projectId:"aera-3f59e",storageBucket:"aera-3f59e.firebasestorage.app",messagingSenderId:"533520508445",appId:"1:533520508445:web:a0906e788e0d6e524888f4",measurementId:"G-J7K9HKBL6K",databaseURL:"https://aera-3f59e-default-rtdb.firebaseio.com"},Eo=Ds(zd);kc(Eo);const pi=$d(Eo);window.addEventListener("DOMContentLoaded",function(){document.getElementById("Typing-Region").focus()});document.getElementById("send").addEventListener("click",Io);document.getElementById("Typing-Region").addEventListener("keypress",n=>{n.key==="Enter"&&(n.preventDefault(),Io())});function Io(){const n=document.getElementById("Typing-Region").innerText.trim();n!==""&&(Kd(n).then(e=>null),wo(n))}document.querySelector("form").addEventListener("submit",async n=>{n.preventDefault();const e=document.querySelector("input").value.trim();if(e){const t=jd();sessionStorage.setItem("userId",t),sessionStorage.setItem("userName",e);const i=di(pi,`users/${t}`);await vo(i,{username:e,userId:t,online:!0,lastActive:Co()}),alert(`Welcome ${e}! You are now logged in.`),document.getElementsByClassName("FirstView")[0].style.display="none",document.querySelector("main").style.display="block",Yd()}});function jd(){if(crypto?.randomUUID)return crypto.randomUUID();if(crypto?.getRandomValues){const n=new Uint32Array(4);return crypto.getRandomValues(n),n.join("-")}else return"user-"+Math.floor(Math.random()*1e6)}async function Kd(n){const e=Pd(di(pi,"Messages")),t={userID:sessionStorage.getItem("userId"),userName:sessionStorage.getItem("userName"),msg:n,timeStamp:Co()};await vo(e,t),console.log("Message sent successfully")}function Yd(){const n=di(pi,"Messages");Od(n,e=>{const t=e.val();wo(t.msg)})}function wo(n){const e=document.createElement("div");e.classList.add("NewMessage"),e.textContent=n,document.getElementById("Chat-Box").appendChild(e),document.getElementById("Typing-Region").innerText="",document.getElementById("Typing-Region").focus()}
